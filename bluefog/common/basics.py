...
class BlueFogBasics(object):
    ...
    def is_initialized(self) -> bool:
        """Return whether BlueFog runtime has been initialized.
        This mirrors torch.distributed.is_initialized() semantics.
        """
        try:
            # bluefog_* C APIs return -1 before initialization.
            return self._MPI_LIB_CTYPES.bluefog_size() != -1
        except Exception:  # pragma: no cover - defensive
            return False
    def is_available(self) -> bool:
        """Return whether BlueFog is available in the current runtime.
        If the extension is importable and this object is constructed,
        BlueFog is considered available.
        """
        try:
            return self._MPI_LIB_CTYPES is not None
        except Exception:  # pragma: no cover - defensive
            return False
